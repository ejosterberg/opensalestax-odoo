...
pip install 'odoo-addon-account-ostax>=17.0.0.1.15,<18.0'  # for Odoo 17
# (use >=16.0.0.1.12,<17.0 / >=18.0.0.1.15,<19.0 / >=19.0.0.1.15,<20.0
# for the other branches)

# Or install from source:
git clone -b 17.0 https://github.com/ejosterberg/opensalestax-odoo.git
